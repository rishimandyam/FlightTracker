 ...
 */
public class AirplanePlaceholder implements IAirplane, Comparable<IAirplane> {
    ...
    private ITime planeTime; // the ITime of the plane's arrival or departure time
     ...
     *                  etc
     */
    public AirplanePlaceholder(boolean isArrival, String flightID, String airport, ITime planeTime, String company) {
    ...
    public String toString() {
        if (!this.isArrival) {
            return company + " Flight: " + flightID + " Departing: " + airport + "\t" + planeTime.toString();
        }
        return null;
    }
}
